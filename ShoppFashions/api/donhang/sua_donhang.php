...
$donHang->don_hang_id = $data->don_hang_id; // ID đơn hàng cần sửa
...
$result = $donHang->suaDonHang();
if ($result == true) {
    echo json_encode(array("message" => "Sửa đơn hàng thành công"));
} else {
    echo json_encode(array("message" => "Sửa đơn hàng thất bại"));
}
?>